...
export const DEFAULT_PROMPT = [
  ...
  "not have seen it — put them under NEEDS YOU as 'Email replies waiting (<n>): Name (Role) —",
  "first words', same shape as the Indeed line. Other refusals are log items, not needs-you.",
