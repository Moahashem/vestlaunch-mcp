...
const DEFAULT_PROMPT = [
  ...
  "website, wix, wizehire, true_analysis. hazelequity always returns unswept —",
  "report it as UNSWEPT, never as zero applicants. (3) For each in-scope,",
  "relevant applicant, call send_recruiting_invite — dedup, the do-not-contact",
