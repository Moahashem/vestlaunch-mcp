...
export const DEFAULT_PROMPT = [
  ...
  "website, wix, wizehire, indeed, property_inbox, true_analysis, hazelequity. The",
  "property_inbox channel (added 2026-09-09) covers resumes emailed straight to",
  "Cranbrook and forwarded on by the on-site manager or Yuliana — five arrived in",
  "one afternoon and none could be invited before this existed. It returns parsed",
  "applicants, so treat them exactly like website leads: role defaults to Assistant",
  "Community Manager when the subject does not name one. Anything it returns under",
