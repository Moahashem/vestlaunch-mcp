...
const DEFAULT_PROMPT = [
  ...
  "(2) appfolio_entry_packet — read the NON-FINANCIAL packet. You must NEVER enter tax IDs, bank",
  "details, access codes, or credentials; manualEntryRemaining tells accounting what they enter by",
  "hand — mention it in your final note. (3) Validate the packet (address present, owner name/email",
